...
public class UpdateSnippetInfoHandlerTest {
    ...
    void testGoodInput(String incoming) throws IOException {
        ...
        UpdateSnippetInfoRequest request = new Gson().fromJson(incoming, UpdateSnippetInfoRequest.class);
    ...
    public void testUpdateHandler() {
        ...
        try {
            ...
            testGoodInput("{\"ID\": \"" + uuid + "\", \"info\": \"Updated Info\"}");

            dao.deleteSnippet(uuid);
        } catch (Exception e) {
            Assert.fail("Test Update Info failed");
        }
    }
    ...
    public void testUpdateBadInput() {
        ...
        try {
            testBadInput("{\"ID\": \"" + uuid + "\", \"Info\": \"Updated Info\"}");
        } catch (Exception e) {
            Assert.fail("Test Bad Update Info failed");
        }
    }
